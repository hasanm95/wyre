...
const file_proto_greeter_proto_rawDesc = "" +
	"\n" +
	"\x13proto/greeter.proto\x12\x04wyre\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2>\n" +
	"\aGreeter\x123\n" +
	"\bSayHello\x12\x12.wyre.HelloRequest\x1a\x13.wyre.HelloResponseB Z\x1egithub.com/hasanm95/wyre/protob\x06proto3"
...
var file_proto_greeter_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: wyre.HelloRequest
	(*HelloResponse)(nil), // 1: wyre.HelloResponse
}
var file_proto_greeter_proto_depIdxs = []int32{
	0, // 0: wyre.Greeter.SayHello:input_type -> wyre.HelloRequest
	1, // 1: wyre.Greeter.SayHello:output_type -> wyre.HelloResponse
